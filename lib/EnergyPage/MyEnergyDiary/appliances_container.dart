...
class _AppliancesContainerState extends State<AppliancesContainer> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AddApplianceDialog(
          ...
          addmonthlyPatternController: addMonthlyPatternController,
          formKey: formKey,
  ...
  Future<void> addAppliance() async {
    ...
    if (userId == null) {
      print("User ID is null. Cannot add appliance.");
      return;
    }
    ...
    var response = await http.post(
      ...
      body: jsonEncode(<String, dynamic>{
        ...
        'applianceData': {
          ...
          'wattage': addWattageController.text,
          'usagePatternPerDay': addUsagePatternController.text,
          'monthlyUsagePattern': addMonthlyPatternController.text,
        },
      }),
    );
  ...
  Future<void> getMonthly() async {
    ...
    final url =
        Uri.parse("http://10.0.2.2:8080/totalMonthlyConsumption/$userId");
    ...
    if (response.statusCode == 200) {
      ...
      print(
          'Fetched totalMonthlyConsumption: ${dailyCost['totalMonthlyConsumption']}');
    } else {
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            TotalCostDisplay(
              cost: '${dailyCost['totalMonthlyConsumption'] ?? 'N/A'}',
            ),
